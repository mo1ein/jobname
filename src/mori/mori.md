...
```mermaid
flowchart LR
    sr(Send Resume) --> hr(HR Call) --> Task(Task) --> tr(Task Review) --rejected--x hri(HR Interview) -.-> o(Offer)
```
...
- **Sent Resume**<br />1403.08.09

- **HR Call**<br />1403.08.23

- **Task**<br />1403.08.23

- **Task Review**<br />1403.09.04

- **Rejection Email**<br />1403.09.16
...
- Feature for previous task (**live code**): We want to sell our code as a service to companies using tokens.<br /> For example: 4 companies can use our search service for their own products.
